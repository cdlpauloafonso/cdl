    ...
    <div>
      ...
      <div className="mb-6">
        <Link
          ...
          className="block p-8 rounded-xl bg-gradient-to-r from-green-600 to-green-700 text-white hover:shadow-lg transition-all border-2 border-transparent hover:border-white/20"
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-green-100">Planos</p>
              <p className="mt-2 text-4xl font-bold">📋</p>
              <p className="mt-1 text-sm text-green-100">Gerenciar planos</p>
            </div>
            <div className="w-16 h-16 rounded-full bg-white/20 flex items-center justify-center">
              <svg
                className="w-8 h-8 text-white"
