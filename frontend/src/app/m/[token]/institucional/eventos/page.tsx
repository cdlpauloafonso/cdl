...
export const metadata: Metadata = {
  title: 'Eventos — CDL Paulo Afonso',
  description: 'Eventos e campanhas no modo app.',
  robots: { index: false, follow: false },
};

export default async function MobileEventosSegmentPage({
  params,
}: {
  ...
  return (
    <MobileCampanhasPage
      segment={`/m/${token}`}
      title="Eventos"
      subtitle="Palestras, campanhas e encontros da CDL Paulo Afonso."
    />
  );
}
