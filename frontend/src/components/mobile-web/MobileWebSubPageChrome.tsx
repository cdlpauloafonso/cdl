...
export function MobileWebSubPageChrome({
  ...
  return (
    <div className="relative isolate flex min-h-0 flex-1 flex-col text-slate-100">
      ...
      <main className="relative z-10 -mt-2 flex min-h-0 flex-1 flex-col overscroll-y-none rounded-t-[1.75rem] bg-gradient-to-b from-slate-100 to-[#eef2fb] px-4 pb-[max(2.5rem,env(safe-area-inset-bottom,0px))] pt-6 text-slate-900 shadow-[0_-12px_40px_rgba(15,23,42,0.35)]">
