...
const LINEAR_BLEED =
  'pointer-events-none absolute inset-x-0 bottom-0 -top-[100dvh] bg-[linear-gradient(180deg,#1E3A8A_0%,#0b1224_100%)]';
...
const FIXED_LINEAR_BLEED =
  `${FIXED_BLEED_FRAME} bg-[linear-gradient(180deg,#1E3A8A_0%,#0b1224_100%)]`;

const GLOW_HOME_FIXED =
  `${FIXED_BLEED_FRAME} bg-[radial-gradient(ellipse_90%_60%_at_50%_-10%,rgba(59,130,246,0.35),transparent),linear-gradient(180deg,#1E3A8A_0%,#0b1224_100%)]`;

const GLOW_SUBPAGE_FIXED =
  `${FIXED_BLEED_FRAME} bg-[radial-gradient(ellipse_90%_60%_at_50%_-10%,rgba(59,130,246,0.28),transparent),linear-gradient(180deg,#1E3A8A_0%,#0b1224_100%)]`;

const GLOW_HOME =
  'pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_90%_60%_at_50%_-10%,rgba(59,130,246,0.35),transparent),linear-gradient(180deg,#1E3A8A_0%,#0b1224_100%)]';

const GLOW_SUBPAGE =
  'pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_90%_60%_at_50%_-10%,rgba(59,130,246,0.28),transparent),linear-gradient(180deg,#1E3A8A_0%,#0b1224_100%)]';
